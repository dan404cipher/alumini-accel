...
jobPostSchema.methods.addApplication = function(applicantId: string, resume?: string, coverLetter?: string) {
  const existingApplication = this.applications.find(app => app.applicantId.toString() === applicantId);
...
jobPostSchema.methods.updateApplicationStatus = function(applicantId: string, status: string) {
  const application = this.applications.find(app => app.applicantId.toString() === applicantId);
  if (!application) {
