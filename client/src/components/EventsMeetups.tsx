  ...
  const events = [
    {
      ...
      description: "Join our annual tech alumni gathering featuring networking, panel discussions, and startup showcases.",
      date: "March 15, 2024",
    ...
    },
    {
      ...
      description: "Watch our alumni entrepreneurs pitch their latest ventures. Great for networking and learning about innovation.",
      date: "March 22, 2024",
    ...
    },
    {
      ...
      description: "Interactive workshop covering resume building, interview skills, and career advancement strategies.",
      date: "March 28, 2024",
    ...
    },
    {
      ...
      description: "Connect with alumni from around the world in our annual reunion celebration with dinner and entertainment.",
      date: "April 5, 2024",
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {events.filter(event => event.featured).map((event) => (
            <Card key={event.id} className="group hover:shadow-strong transition-smooth cursor-pointer animate-fade-in-up bg-gradient-card border-0 overflow-hidden">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          {events.filter(event => !event.featured).map((event) => (
            <Card key={event.id} className="group hover:shadow-medium transition-smooth cursor-pointer animate-fade-in-up bg-gradient-card border-0">
              <CardContent className="p-6">
